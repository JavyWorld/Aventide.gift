# waterfall · Transcripción integral desde `waterfall-engine-v10-260207_0941.docx`

> Este archivo es una transcripción documental completa del `.docx` histórico para lectura IA/humana en formato Markdown.

## Metadatos

- Fuente original: `Sistemas/waterfall-engine-v10-260207_0941.docx`
- Dominio canónico asociado: `waterfall`
- Título detectado: Brutal, mi Jav. Vamos a dejar ese Waterfall de pérdidas como tanque de guerra empresarial: claro, auditable, difícil de explotar y listo para implementación real. ⚙️🛡️
...
- Orden fijo de cobertura (no alterable por operación manual):
...
- COL Liability
- Global Reserve
- Generación de deuda recuperable contra COL
- Estados del caso:
...
- calcular earnings brutos del COL (gross_col_earnings)
- calcular cuota de recuperación (recovery_cut)
- transferir recovery_cut a Global Reserve
- bajar deuda pendiente
- Fórmula robusta
- recovery_cut = min(
- outstanding_debt,
...
- stop de campañas promocionales en ese país
- restricción de métodos de pago de alto riesgo
- comité de crisis (Risk + Finance + Legal)
...
- Debes dejar textual:
- Responsabilidad financiera operativa del país
- Derecho de compensación automática (set-off)
- Prioridad del Waterfall
- Recovery obligatorio sobre earnings futuros
- Eventos de default
- Facultad de reemplazo operativo del COL por incumplimiento grave
