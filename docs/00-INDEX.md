...
> **Fuente de verdad inicial:** los 38 archivos `.docx` ubicados en el root del repo. Este índice **no reemplaza** esos originales; solo los referencia y normaliza para navegación.
